	...
	<div class="container">
		...
		<div class="row heading-bg">
			...
			<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
				<h5 class="txt-dark">
					@isset($edit) ویرایش برند {{$title}} @else ثبت برند جدید @endisset
				</h5>
			</div>
			...
			<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
				<ol class="breadcrumb">
					<li class="active">
						<span>@isset($edit) ویرایش برند {{$title}} @else ثبت برند جدید @endisset</span>
					</li>
					<li>فروشگاه</li>
					<li>داشبورد</li>
				</ol>
				...
				<div class="panel panel-default card-view">
					<div class="panel-wrapper collapse in">
						<div class="panel-body pt-0">
							<div class="form-wrap">
								<form action="@isset($brand) {{ route('brand.update', $brand->id) }} @else {{ route('brand.store') }} @endisset" method="POST">
									...
									<div class="row">
										<div class="@isset($edit) col-md-12 @else col-md-12 @endisset">
											<div class="form-group">
												<label class="control-label mb-10" for="title">نام برند</label>
												<div class="input-group">
													<input type="text" name="title" id="title" @isset($brand) value="{{$brand->title}}" @else value="{{old('title')}}" @endisset class="form-control" placeholder="مثلا : Samsung" />
									...
									<div class="form-actions">
										<button class="btn @isset($edit) btn-warning {{$title}} @else btn-primary @endisset btn-icon right-icon mr-10 pull-left"> <i class="fa fa-check"></i>
											<span>@isset($edit) ویرایش @else ثبت @endisset برند</span>
										</button>
		...
		<div class="row heading-bg">
			<!-- Breadcrumb -->
			<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
				<h5 class="txt-dark">لیست برند ها</h5>
			</div>
											...
											<tr>
												...
												<td>
													<form action="{{ route('brand.destroy', ['brand' => $item->id]) }}" method="POST">
														<a href="{{ route('brand.edit', ['brand' => $item->id]) }}" class="btn btn-warning"><i class="icon ti-pencil"></i> ویرایش</a>
