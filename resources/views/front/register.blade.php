...
<head>
    ...
    <title>Cointrade HTML Website Template - Sign up Page </title>
    <!-- Bootstrap -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="offset-xl-3 col-xl-6 offset-lg-1 col-lg-10 col-md-12 col-sm-12 col-12 ">
                    ...
                    <p class="text-white">Already have an account?<a href="#" class="text-yellow"> Sign In</a> <span class="pull-right"><a href="index.html" class="text-white">Back to Home</a></span> </p>
                </div>
                <!-- /.register-form -->
            </div>
        </div>
